...
class Reporte7 extends React.Component {
    state = {
        form: {
            Variable1: '',
            Variable2: '',
    ...
    handleSubmit = async e => {
        ...
        try {
            ...
            let res = await fetch('http://3.16.160.225:4000/Reporte7', config)
            ...
            <div>
                ...
                <div className="main-container col-12">
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group controlId="formUsename">
                            <Form.Label>Ingrese Cantidad de Días</Form.Label>
                            <Form.Control type="text" name="Variable5" placeholder="Días" onChange={this.handleChange} value={this.state.form.Variable5} />
                        </Form.Group>
