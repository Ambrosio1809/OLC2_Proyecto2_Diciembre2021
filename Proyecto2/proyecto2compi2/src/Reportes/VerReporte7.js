...
class VerReporte7 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte7`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 7")
        doc.text(125,60, `Tendencia del número de infectados por día en ${this.state.prueba.pais}`)
        doc.setFontSize('15')
        doc.text(100,95,`Para ${this.state.prueba.Dias} dias se obtuvo un aproximado de: ${this.state.prueba.Prediccion} infectados\nSe realizo una regresión polinomial de grado ${this.state.prueba.grado}\nCon un error cuadratico (RMSE) medio de : ${this.state.prueba.RMSE}\ny un porcentaje de variación (R2) de: ${this.state.prueba.R2}`)
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.7</h1>
                    <h3>Tendencia del número de infectados por día de un País.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presenta tendencia del número de infectados por día en el Pais: {this.state.prueba.pais}<br></br>
                                    Para una cantidad de {this.state.prueba.Dias} dias se tiene un resultado aproximado de: {this.state.prueba.Prediccion} infectados<br></br>
