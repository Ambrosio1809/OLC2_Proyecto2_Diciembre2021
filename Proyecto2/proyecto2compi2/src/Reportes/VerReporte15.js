...
class VerReporte15 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte15`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 15")
        doc.text(30,60, `Tendencia de casos confirmados de Coronavirus en un departamento de ${this.state.prueba.pais}`)
        doc.setFontSize('15')
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.15</h1>
                    <h3>Tendencia de casos confirmados de Coronavirus en un departamento de un País.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presentan la Tendencia de casos confirmados de Coronavirus en un departamento de: {this.state.prueba.pais}<br></br>                                    
