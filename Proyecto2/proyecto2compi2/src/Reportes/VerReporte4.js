...
class VerReporte4 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte4`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 4")
        doc.text(115,60, `Predicción de mortalidad por COVID en ${this.state.prueba.pais}`)
        doc.setFontSize('15')
        doc.text(100,100,`Para ${this.state.prueba.Dias} dias se obtiene aprox: ${this.state.prueba.Prediccion} muertes \nSe realizó con una regresión polinomial de grado ${this.state.prueba.grado}\nCon un error cuadratico (RMSE) medio de : ${this.state.prueba.RMSE}\ny un porcentaje de variación (R2) de: ${this.state.prueba.R2}`) 
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.4</h1>
                    <h3>Predicción de mortalidad por COVID en un Departamento.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presenta la Predicción de mortalidad por COVID en el departamento de {this.state.prueba.pais}<br></br>
                                    Para una cantidad de {this.state.prueba.Dias} dias se tiene un resultado aproximado de: {this.state.prueba.Prediccion} muertes<br></br>
