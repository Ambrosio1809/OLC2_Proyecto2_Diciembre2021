...
class Reporte19 extends React.Component {
    state = {
        form: {
            Variable1: '',
            Variable2: '',
    ...
    handleSubmit = async e => {
        ...
        try {
            ...
            let res = await fetch('http://3.16.160.225:4000/Reporte19', config)
        ...
        return (
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Parametros Reporte No.19</h1>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group controlId="formUsename">
                            ...
                            <Form.Control type="text" name="Variable4" placeholder="Columna_Dia" onChange={this.handleChange} value={this.state.form.Variable4} />
                        </Form.Group>
