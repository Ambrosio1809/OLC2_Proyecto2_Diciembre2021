...
class VerReporte17 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte17`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 17")
        doc.text(50,60, `Tasa de comportamiento de casos activos en relación al número de muertes en\n${this.state.prueba.pais}`)
        doc.setFontSize('15')
        doc.text(100,115,`El cual se realizó con una regresión polinomial de grado ${this.state.prueba.grado}\nCon un error cuadratico (RMSE) medio de : ${this.state.prueba.RMSE}\ny un porcentaje de variación (R2) de: ${this.state.prueba.R2}`) 
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.17</h1>
                    <h3>Tasa de comportamiento de casos activos en relación al número de muertes en un continente.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presentan la Tasa de comportamiento de casos activos en relación al número de muertes en un continente. 
                                    <br></br>{this.state.prueba.pais}<br></br>                                    
