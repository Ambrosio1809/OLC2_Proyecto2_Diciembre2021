...
class VerReporte9 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte9`)
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.9</h1>
                    <h3>Tendencia de la vacunación de en un País.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presenta la Tendencia de la vacunación de en: {this.state.prueba.pais}<br></br>
