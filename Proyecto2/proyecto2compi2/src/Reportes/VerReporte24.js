...
class VerReporte24 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte24`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 24")
        doc.text(75,60, `Comparación entre el número de casos detectados y el número de pruebas\nde ${this.state.prueba.pais}`)
        doc.setFontSize('15')
        doc.text(100,95,`Para el primer gráfico de casos detectados\nSe realizó con una regresión polinomial de grado ${this.state.prueba.grado}\nCon un error cuadratico (RMSE) medio de : ${this.state.prueba.RMSE1}\ny un porcentaje de variación (R2) de: ${this.state.prueba.R21}`) 
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.24</h1>
                    <h3>Comparación entre el número de casos detectados y el número de pruebas de un país</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presenta la Comparación entre el número de casos detectados y el número de pruebas de un país:<br></br> 
                                    {this.state.prueba.pais}<br></br>
                                    Para el primer gráfico de casos detectados<br></br>
                            ...
                            <tr>
                                <td>
                                    A continuación se presenta la Comparación entre el número de casos detectados y el número de pruebas de un país:<br></br> 
                                    {this.state.prueba.pais}<br></br>
                                    Para el segundo gráfico de numero de pruebas<br></br>
                                    Se realizó con una regresión polinomial de grado {this.state.prueba.grado}<br></br>
