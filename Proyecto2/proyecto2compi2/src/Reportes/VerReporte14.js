...
class VerReporte14 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte14`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 14")
        doc.text(125,60, `Muertes según regiones de ${this.state.prueba.pais} - Covid 19.`)
        doc.setFontSize('15')
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.14</h1>
                    <h3>Muertes según regiones de un país - Covid 19.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presentan las Muertes según regiones de un país - Covid 19 en : {this.state.prueba.pais}<br></br>                                    
