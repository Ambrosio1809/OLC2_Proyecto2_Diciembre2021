...
class VerReporte19 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte19`)
    ...
    handleSubmit = async e => {
        ...
        doc.text(250,35, "Reporte No. 19")
        doc.text(45,60, `Predicción de muertes en el último día del primer año de infecciones en\n${this.state.prueba.pais}`)
        doc.setFontSize('15')
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.19</h1>
                    <h3>Predicción de muertes en el último día del primer año de infecciones en un país.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presentan la Predicción de muertes en el último día del primer año de infecciones en: {this.state.prueba.pais}<br></br>                                    
