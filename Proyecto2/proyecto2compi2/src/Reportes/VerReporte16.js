...
class VerReporte16 extends React.Component {
    ...
    async componentDidMount() {
        const res = await fetch(`http://3.16.160.225:4000/GetReporte16`)
        ...
        return (
            ...
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Reporte No.16</h1>
                    <h3>Porcentaje de muertes frente al total de casos en un país, región o continente.</h3>
                    ...
                    <Table>
                        <tbody align="center">
                            <tr>
                                <td>
                                    A continuación se presentan el Porcentaje de muertes frente al total de casos en un país, región o continente: 
