...
class Reporte22 extends React.Component {
    state = {
        form: {
            Variable1: '',
            Variable2: '',
    ...
    handleSubmit = async e => {
        ...
        try {
            ...
            let res = await fetch('http://3.16.160.225:4000/Reporte22', config)
        ...
        return (
            <div>
                ...
                <div className="main-container col-12">
                    <h1>Parametros Reporte No.22</h1>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group controlId="formUsename">
                            <Form.Label>Ingrese Nombre Columna Confirmados</Form.Label>
